...
@Component({
  ...
  `,
  styles: [`.timeline-item{position:relative;padding-left:1.75rem;border-left:2px solid #e5e7eb}.timeline-item:last-child{padding-bottom:0!important}.timeline-marker{position:absolute;left:-.42rem;top:.2rem;width:.72rem;height:.72rem;border-radius:50%;background:var(--color-primary);border:2px solid #fff;box-shadow:0 0 0 1px var(--color-primary)}`]
})
